...
CREATE TABLE "doctorSpecialties" (
    ...
    CONSTRAINT "doctorSpecialties_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_document_embedding_isDeleted" ON "document_embeddings"("isDeleted");
...
-- CreateIndex
CREATE INDEX "idx_doctor_specialty_doctorId" ON "doctorSpecialties"("doctorId");

-- CreateIndex
CREATE INDEX "idx_name_doctor_specialty_specialtyId" ON "doctorSpecialties"("specialtyId");

-- CreateIndex
CREATE UNIQUE INDEX "doctorSpecialties_doctorId_specialtyId_key" ON "doctorSpecialties"("doctorId", "specialtyId");
...
-- AddForeignKey
ALTER TABLE "doctorSpecialties" ADD CONSTRAINT "doctorSpecialties_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "doctor"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "doctorSpecialties" ADD CONSTRAINT "doctorSpecialties_specialtyId_fkey" FOREIGN KEY ("specialtyId") REFERENCES "specialties"("id") ON DELETE CASCADE ON UPDATE CASCADE;
