...
/**
 * /doctors?specialty=cardiology&searchTerm=naz&include=doctor.schedule
 *
 * */
 ...
 * I= model---> like user,doctor, specialty etc
 * 
 * IWhereInput --> where shape of model
 * 
 * IInclude ---> include shape of model
 * 
 * */
